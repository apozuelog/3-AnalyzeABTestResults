...
print('Graphic representation of p_new and p_old. The red mark represents the real value of the hypothesis.')
...
# **Yes, when putting alternative = small the new page conversion rate is greater than the old one and this returns a p-value similar to the p-value calculated before. We can not reject the null hypothesis.**
